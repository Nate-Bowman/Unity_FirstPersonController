namespace Player
{
	...
	public class PlayerController : MonoBehaviour
	{
		...
		[SerializeField, Tooltip("The fall speed modifier, increases gravity")]
		...
		private void HandleAirMovement()
		{
			...
			var inputAsMovement = new Vector3(inputAxes.x, 0f, inputAxes.y);
			...
			var worldSpaceMovement = transform.TransformVector(inputAsMovement);
		...
		private void HandleCameraMovement()
		{
			...
			var inputAxes = new Vector2(Input.GetAxisRaw("Horizontal_Camera"), Input.GetAxisRaw("Vertical_Camera"));
